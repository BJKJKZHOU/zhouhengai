...
![电流环控制框图-浅色]({{ 'assets/img/2025-10-21-SPMSM的FOC初始PID参数参考/电流环1 light.svg' | relative_url }}){: .light .w-75 .rounded-10 }
![电流环控制框图-深色]({{ 'assets/img/2025-10-21-SPMSM的FOC初始PID参数参考/电流环1 dark.svg' | relative_url }}){: .dark .w-75 .rounded-10 }
...
![转数环控制框图-浅色]({{ 'assets/img/2025-10-21-SPMSM的FOC初始PID参数参考/转数环框图 1 light.svg' | relative_url }}){: .light .w-75 .rounded-10 }
![转数环控制框图-深色]({{ 'assets/img/2025-10-21-SPMSM的FOC初始PID参数参考/转数环框图 1 dark.svg' | relative_url }}){: .dark .w-75 .rounded-10 }
